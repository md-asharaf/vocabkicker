package com.vocabkicker.serverless;
        ...
        try {
            ...
            if (dataFile.exists()) {
                ...
                for (Map<String, Object> q : questions) {
                    ...
                    if (mnemonic != null) questionItem.put("mnemonic", AttributeValue.builder().s(mnemonic).build());
                    if (definition != null) questionItem.put("definition", AttributeValue.builder().s(definition).build());
