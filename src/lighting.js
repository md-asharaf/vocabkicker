/**
 * lighting.js
 * Daytime stadium lighting:
 *  - HemisphereLight  sky↔ground  — fills everything with natural ambient colour
 *  - DirectionalLight (sun)       — sharp shadows from a high angle
 *  - 3 × PointLight               — stadium floodlights (corners + back)
 */
